...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        # self.tableWidget_3.setGeometry(QtCore.QRect(600, 100, 202, 452))  # Position and size (x, y, width, height)
        # self.tableWidget_3.setRowCount(15)  # Set the number of rows
        # self.tableWidget_3.setColumnCount(2)  # Set the number of columns
